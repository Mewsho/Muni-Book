...
const resolvers = {
  ...
  Mutation: {
    ...
    async addDocumento(obj, { input }) {
      ...
      let categoriaDocumentoBus = await CategoriaDocumento.findById(
        input.categoriaDocumento
      );
      ...
      let documento = new Documento({
        ...
        categoriaDocumento: categoriaDocumentoBus._id,
      });
